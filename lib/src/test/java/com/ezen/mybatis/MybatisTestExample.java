...
public class MybatisTestExample {
	...
	public static void main(String[] args) {
		...
		String searchName = "e".toUpperCase();
		...
		emp.setFirstName("KAI");
		emp.setLastName("Harvert");
		...
		updateEmp.setId(200);
		//updateEmp.setFirstName("진첸코");
		updateEmp.setLastName("Olexandro");
		updateEmp.setSalary(30000);
